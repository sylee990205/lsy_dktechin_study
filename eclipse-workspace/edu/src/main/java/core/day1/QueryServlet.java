...
public class QueryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		...
		String food[] = request.getParameterValues("food"); //value가 여러개일 땐 getParameterValues
		...
		out.print("<h2>당신이 좋아하는 숫자는 "+
                number+"이군요!</h2>");
		out.print("<a href='"+request.getHeader("referer")+"'>입력화면으로 가기</a>"); //getHeader("referer") 이전 페이지의 URL을 가져옴
		out.close();
	}
